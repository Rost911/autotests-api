...
class GetCoursesQuerySchema(BaseModel):
    """
    Description of the structure of the request for retrieving the list of courses.
    """
    model_config = ConfigDict(populate_by_name=True)
...
class GetCoursesResponseSchema(BaseModel):
    """
    Description of the structure of the response for retrieving the list of courses.
    """
...
class UpdateCourseResponseSchema(BaseModel):
    """
    Description of the structure of the course update response.
    """
    course: CourseSchema